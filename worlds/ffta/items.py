...
VanillaShopTier0: typing.List[typing.Tuple[str, int]] = [
    ("Bronze Helm", "default"),
    ("Feather Cap", "default"),
    ("Green Beret", "default"),
    ("Cuirass", "default"),
    ("Bronze Armor", "default"),
    ("Leather Garb", "default"),
    ("Chain Plate", "default"),
    ("Hempen Robe", "default"),
    ("Shortsword", "default"),
    ...
    ("Glass Bell", "default"),
    ("War Trumpet", "default"),
    ("Hard Knuckles", "default"),
    ("Rising Sun", "default"),
    ("Aiot Gun", "default"),
    ("Bronze Shield", "default"),
    ("Battle Boots", "default"),
    ("Gauntlets", "default"),
    ("Potion", "default"),
    ("Hi-Potion", "default"),
    ("X-Potion", "default"),
    ...
    ("Eye Drops", "default"),
    ("Echo Screen", "default"),
    ("Maiden's Kiss", "default"),
    ("Soft", "default"),
    ("Holy Water", "default"),
    ("Bandage", "default"),
    ("Phoenix Down", "default"),
]

VanillaShopTier1: typing.List[typing.Tuple[str, int]] = [
    ("Iron Helm", "default"),
    ("Iron Armor", "default"),
    ("Adaman Vest", "default"),
    ("Survival Vest", "default"),
    ("Silken Robe", "default"),
    ("Buster Sword", "default"),
    ("Shadow Blade", "default"),
    ("Sun Blade", "default"),
    ("Atmos Blade", "default"),
    ("Blue Saber", "default"),
    ("Shamshir", "default"),
    ...
    ("Lionheart", "default"),
    ("Ragnarok", "default"),
    ("Ancient Sword", "default"),
    ("Samson Sword", "default"),
    ("Estoc", "default"),
    ("Flamberge", "default"),
    ("Ninja Knife", "default"),
    ("Murasame", "default"),
    ...
    ("Energy Mace", "default"),
    ("Druid Mace", "default"),
    ("Sage Crosier", "default"),
    ("Silver Bow", "default"),
    ("Windslash Bow", "default"),
    ("Ranger Bow", "default"),
    ("Cranequin", "default"),
    ("Javelin", "default"),
    ("Lava Spear", "default"),
    ...
    ("Black Quena", "default"),
    ("Satyr Flute", "default"),
    ("Sick Knuckles", "default"),
    ("Dream Claws", "default"),
    ("Kaiser Knuckles", "default"),
    ("Silver Cannon", "default"),
    ("Round Shield", "default"),
]

VanillaShopTier2: typing.List[typing.Tuple[str, int]] = [
    ("Opal Helm", "default"),
    ("Circlet", "default"),
    ("Headband", "default"),
    ("Platemail", "default"),
    ("Gold Armor", "default"),
    ("Brigandine", "default"),
    ("Judo Uniform", "default"),
    ("Power Sash", "default"),
    ("Magus Robe", "default"),
    ("Mistle Robe", "default"),
    ("Burglar Sword", "default"),
    ("Flametongue", "default"),
    ("Air Blade", "default"),
    ("Icebrand", "default"),
    ("Kwigon Blade", "default"),
    ("Ogun Blade", "default"),
    ("Paraiba Blade", "default"),
    ("Aqua Saber", "default"),
    ("Defender", "default"),
    ("Lohengrin", "default"),
    ("Predator", "default"),
    ...
    ("Khukuri", "default"),
    ("Kard", "default"),
    ("Rondell Dagger", "default"),
    ("Mage Masher", "default"),
    ("Kikuichimonji", "default"),
    ("Heaven's Cloud", "default"),
    ("Cure Staff", "default"),
    ("Garnet Staff", "default"),
    ("Force Rod", "default"),
    ("Nail Bow", "default"),
    ("Twin Bow", "default"),
    ("Gae Bolg", "default"),
    ("Dragon Whisker", "default"),
    ("Riot Gun", "default"),
    ("Chaos Rifle", "default"),
    ("Opal Shield", "default"),
    ("Spiked Boots", "default"),
    ("Dash Boots", "default"),
    ("Fortune Ring", "default"),
    ("Scarab", "default"),
]

itemGroups: typing.Dict[str, typing.List[typing.Tuple[str, int]]] = {
