...
def my_launch(*launch_args) -> None:
    ...
    Utils.init_logging("BizHawkClientFFTA2", exception_logger="Client")
    import colorama
    colorama.init()
    asyncio.run(main())
    colorama.deinit()
...
component = Component("BizHawk Client FFTA2", "BizHawkClientFFTA2", component_type=Type.CLIENT, func=my_launch_client,
