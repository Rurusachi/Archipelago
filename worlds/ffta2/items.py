...
LootMagicite: typing.List[ItemData] = [
    ...
    ItemData("Soul Ceffyl", ItemClassification.progression, 0x01B2),
    ItemData("Earthwyrm Crystal", ItemClassification.progression, 0x01B3),
    ItemData("Windgod Crystal", ItemClassification.progression, 0x01B4),
    ItemData("Waterwyrd Crystal", ItemClassification.progression, 0x01B5),
    ItemData("Firebird Crystal", ItemClassification.progression, 0x01B6),
    ItemData("Snowcat Crystal", ItemClassification.progression, 0x01B7),
    ItemData("Stormsoul Crystal", ItemClassification.progression, 0x01B8),
    ItemData("Lightwing Crystal", ItemClassification.progression, 0x01B9),
    ItemData("Darklord Crystal", ItemClassification.progression, 0x01BA),
    ItemData("Earth Stone", ItemClassification.progression, 0x01BB),
    ItemData("Wind Stone", ItemClassification.progression, 0x01BC),
    ItemData("Water Stone", ItemClassification.progression, 0x01BD),
    ItemData("Fire Stone", ItemClassification.progression, 0x01BE),
    ItemData("Ice Stone", ItemClassification.progression, 0x01BF),
    ItemData("Storm Stone", ItemClassification.progression, 0x01C0),
    ItemData("Holy Stone", ItemClassification.progression, 0x01C1),
    ItemData("Dark Stone", ItemClassification.progression, 0x01C2),
    ItemData("Wind Sigil", ItemClassification.progression, 0x01C3),
    ItemData("Earth Sigil", ItemClassification.progression, 0x01C4),
    ItemData("Fire Sigil", ItemClassification.progression, 0x01C5),
    ItemData("Water Sigil", ItemClassification.progression, 0x01C6),
    ItemData("Storm Sigil", ItemClassification.progression, 0x01C7),
    ItemData("Ice Sigil", ItemClassification.progression, 0x01C8),
    ItemData("Low Arcana", ItemClassification.progression, 0x01C9),
...
LootMetals: typing.List[ItemData] = [
    ...
    ItemData("Mythril", ItemClassification.progression, 0x01CE),
    ItemData("Adamant Alloy", ItemClassification.progression, 0x01CF),
    ItemData("Crusite Alloy", ItemClassification.progression, 0x01D0),
    ItemData("Mysidia Alloy", ItemClassification.progression, 0x01D1),
    ItemData("Scarletite", ItemClassification.progression, 0x01D2),
    ItemData("Damascus", ItemClassification.progression, 0x01D3),
    ItemData("Orichalcum", ItemClassification.progression, 0x01D4),
    ItemData("Einherjarium", ItemClassification.progression, 0x01D5),
    ItemData("Gemsteel", ItemClassification.progression, 0x01D6),
    ItemData("Zinconium", ItemClassification.progression, 0x01D7),
    ItemData("Zincatite", ItemClassification.progression, 0x01D8),
    ItemData("Xergis Tin", ItemClassification.progression, 0x01D9),
    ItemData("Cruzle Brass", ItemClassification.progression, 0x01DA),
    ItemData("Dipraeu Bronze", ItemClassification.progression, 0x01DB),
    ItemData("Platinum", ItemClassification.progression, 0x01DC),
    ItemData("Gikhet Lead", ItemClassification.progression, 0x01DD),
    ItemData("Gun Gear", ItemClassification.progression, 0x01DE),
    ItemData("Clock Gear", ItemClassification.progression, 0x01DF),
    ItemData("Gold Chalice", ItemClassification.progression, 0x01E0),
    ItemData("Trusty Frying Pan", ItemClassification.progression, 0x01E1),
    ItemData("Cursed Coin", ItemClassification.progression, 0x01E2),
    ItemData("Bundle of Needles", ItemClassification.progression, 0x01E3),
    ItemData("Sanative Needle", ItemClassification.progression, 0x01E4),
...
LootSkins: typing.List[ItemData] = [
    ...
    ItemData("Snake Skin", ItemClassification.progression, 0x01E9),
    ItemData("Tyrant Hide", ItemClassification.progression, 0x01EA),
    ItemData("Quality Hide", ItemClassification.progression, 0x01EB),
    ItemData("Tanned Hide", ItemClassification.progression, 0x01EC),
    ItemData("Giant's Tanned Hide", ItemClassification.progression, 0x01ED),
    ItemData("Tanned Tyrant Hide", ItemClassification.progression, 0x01EE),
    ItemData("Prime Tanned Hide", ItemClassification.progression, 0x01EF),
    ItemData("Wolf Pelt", ItemClassification.progression, 0x01F0),
    ItemData("Coeurl Pelt", ItemClassification.progression, 0x01F1),
    ItemData("Quality Pelt", ItemClassification.progression, 0x01F2),
    ItemData("Prime Pelt", ItemClassification.progression, 0x01F3),
    ItemData("Rabbit Pelt", ItemClassification.progression, 0x01F4),
    ItemData("Rabbit Tail", ItemClassification.progression, 0x01F5),
    ItemData("Rat Tail", ItemClassification.progression, 0x01F6),
    ItemData("Pink Tail", ItemClassification.progression, 0x01F7),
    ItemData("Cockatrice Skin", ItemClassification.progression, 0x01F8),
    ItemData("Bat Tail", ItemClassification.progression, 0x01F9),
...
LootBones: typing.List[ItemData] = [
    ...
    ItemData("Blood-darkened Bone", ItemClassification.progression, 0x01FE),
    ItemData("Bomb Shell", ItemClassification.progression, 0x01FF),
    ItemData("Mirror Scale", ItemClassification.progression, 0x0200),
    ItemData("Emperor Scale", ItemClassification.progression, 0x0201),
    ItemData("Cod Scale", ItemClassification.progression, 0x0202),
    ItemData("Lamia Scale", ItemClassification.progression, 0x0203),
    ItemData("Molting", ItemClassification.progression, 0x0204),
    ItemData("Iron Carapace", ItemClassification.progression, 0x0205),
    ItemData("Wyrm Carapace", ItemClassification.progression, 0x0206),
    ItemData("Insect Husk", ItemClassification.progression, 0x0207),
    ItemData("Battlewyrm Carapace", ItemClassification.progression, 0x0208),
    ItemData("Pointed Horn", ItemClassification.progression, 0x0209),
    ItemData("Beastlord Horn", ItemClassification.progression, 0x020A),
    ItemData("Great Serpent's Fang", ItemClassification.progression, 0x020B),
    ItemData("Vampyr Fang", ItemClassification.progression, 0x020C),
    ItemData("Crooked Fang", ItemClassification.progression, 0x020D),
    ItemData("Spiral Incisor", ItemClassification.progression, 0x020E),
    ItemData("Wyvern Fang", ItemClassification.progression, 0x020F),
    ItemData("Gimble Stalk", ItemClassification.progression, 0x0210),
    ItemData("Alraune Drill", ItemClassification.progression, 0x0211),
    ItemData("Zingu Pearl", ItemClassification.progression, 0x0212),
    ItemData("Zingu Pearl Shell", ItemClassification.progression, 0x0213),
    ItemData("Star Fragments", ItemClassification.progression, 0x0214),
    ItemData("Fury Fragments", ItemClassification.progression, 0x0215),
    ItemData("Coral Fragments", ItemClassification.progression, 0x0216),
    ItemData("Turtle Shell", ItemClassification.progression, 0x0217),
    ItemData("Aged Turtle Shell", ItemClassification.progression, 0x0218),
    ItemData("Ancient Turtle Shell", ItemClassification.progression, 0x0219),
    ItemData("Bone Chips", ItemClassification.progression, 0x021A),
...
LootFlora: typing.List[ItemData] = [
    ...
    ItemData("Malboro Flower", ItemClassification.progression, 0x021F),
    ItemData("Marriom Heather", ItemClassification.progression, 0x0220),
    ItemData("Prima Petal", ItemClassification.progression, 0x0221),
    ItemData("Leucojum", ItemClassification.progression, 0x0222),
    ItemData("Kalos", ItemClassification.progression, 0x0223),
    ItemData("Hedychium", ItemClassification.progression, 0x0224),
    ItemData("Nepenthis", ItemClassification.progression, 0x0225),
    ItemData("Recall Grass", ItemClassification.progression, 0x0226),
    ItemData("Whisperweed", ItemClassification.progression, 0x0227),
    ItemData("Ladies' Tresses", ItemClassification.progression, 0x0228),
    ItemData("Flutegrass", ItemClassification.progression, 0x0229),
    ItemData("Goldcap", ItemClassification.progression, 0x022A),
    ItemData("Magick Fruit", ItemClassification.progression, 0x022B),
    ItemData("Power Fruit", ItemClassification.progression, 0x022C),
    ItemData("Succulent Fruit", ItemClassification.progression, 0x022D),
    ItemData("Cactus Fruit", ItemClassification.progression, 0x022E),
    ItemData("Suspect Mushroom", ItemClassification.progression, 0x022F),
    ItemData("Tiny Mushrooms", ItemClassification.progression, 0x0230),
    ItemData("Screamroot", ItemClassification.progression, 0x0231),
    ItemData("Onion", ItemClassification.progression, 0x0232),
    ItemData("Hedychium Pollen", ItemClassification.progression, 0x0233),
    ItemData("Aurea Pollen", ItemClassification.progression, 0x0234),
    ItemData("Faren Pollen", ItemClassification.progression, 0x0235),
    ItemData("Malboro Vine", ItemClassification.progression, 0x0236),
    ItemData("Sturdy Vine", ItemClassification.progression, 0x0237),
    ItemData("Spiral Vine", ItemClassification.progression, 0x0238),
    ItemData("Four-leaf Clover", ItemClassification.progression, 0x0239),
    ItemData("Ball Moss", ItemClassification.progression, 0x023A),
    ItemData("Pearl Moss", ItemClassification.progression, 0x023B),
    ItemData("Tomato Stalk", ItemClassification.progression, 0x023C),
...
LootTimber: typing.List[ItemData] = [
    ...
    ItemData("Moonwood", ItemClassification.progression, 0x0241),
    ItemData("Danbukwood", ItemClassification.progression, 0x0242),
    ItemData("Quality Lumber", ItemClassification.progression, 0x0243),
    ItemData("Cottonflue", ItemClassification.progression, 0x0244),
    ItemData("Waltwood", ItemClassification.progression, 0x0245),
    ItemData("Kempas", ItemClassification.progression, 0x0246),
    ItemData("Agathis", ItemClassification.progression, 0x0247),
    ItemData("Mape Wood", ItemClassification.progression, 0x0248),
    ItemData("Red Geeps", ItemClassification.progression, 0x0249),
    ItemData("Spruce", ItemClassification.progression, 0x024A),
    ItemData("Quince", ItemClassification.progression, 0x024B),
    ItemData("Birch", ItemClassification.progression, 0x024C),
    ItemData("Rose Branch", ItemClassification.progression, 0x024D),
    ItemData("Mahbeny", ItemClassification.progression, 0x024E),
    ItemData("Gurnat", ItemClassification.progression, 0x024F),
    ItemData("Pagoda Wood", ItemClassification.progression, 0x0250),
    ItemData("Kuraisle Boxwood", ItemClassification.progression, 0x0251),
    ItemData("Wyrmtwig", ItemClassification.progression, 0x0252),
...
LootPhiltres: typing.List[ItemData] = [
    ...
    ItemData("Foul Liquid", ItemClassification.progression, 0x0257),
    ItemData("Putrid Liquid", ItemClassification.progression, 0x0258),
    ItemData("Unpurified Ether", ItemClassification.progression, 0x0259),
    ItemData("Hero Tonic", ItemClassification.progression, 0x025A),
    ItemData("Crusader Tonic", ItemClassification.progression, 0x025B),
    ItemData("Healing Water", ItemClassification.progression, 0x025C),
    ItemData("Strange Liquid", ItemClassification.progression, 0x025D),
    ItemData("Fresh Water", ItemClassification.progression, 0x025E),
    ItemData("Aqua Galac", ItemClassification.progression, 0x025F),
    ItemData("Fiend's Blood", ItemClassification.progression, 0x0260),
    ItemData("Malboro Wine", ItemClassification.progression, 0x0261),
    ItemData("Clear Sap", ItemClassification.progression, 0x0262),
    ItemData("Sweet Sap", ItemClassification.progression, 0x0263),
    ItemData("Bitter Sap", ItemClassification.progression, 0x0264),
...
jobUnlockItems: typing.List[ItemData] = [
    ...
    ItemData("Job Unlock: Black Mage", ItemClassification.useful, 0x304),
    ItemData("Job Unlock: Archer", ItemClassification.useful, 0x305),
    ItemData("Job Unlock: Paladin", ItemClassification.useful, 0x306),
    ItemData("Job Unlock: Fighter", ItemClassification.useful, 0x307),
    ItemData("Job Unlock: Parivir", ItemClassification.useful, 0x308),
    ItemData("Job Unlock: Ninja", ItemClassification.useful, 0x309),
    ItemData("Job Unlock: Illusionist", ItemClassification.useful, 0x30a),
    ItemData("Job Unlock: Blue Mage", ItemClassification.useful, 0x30b),
    ItemData("Job Unlock: Hunter", ItemClassification.useful, 0x30c),
    ItemData("Job Unlock: Seer", ItemClassification.useful, 0x30d),
    ItemData("Job Unlock: Warrior", ItemClassification.useful, 0x30e),
    ItemData("Job Unlock: White Monk", ItemClassification.useful, 0x30f),
    ItemData("Job Unlock: Dragoon", ItemClassification.useful, 0x310),
    ItemData("Job Unlock: Defender", ItemClassification.useful, 0x311),
    ItemData("Job Unlock: Gladiator", ItemClassification.useful, 0x312),
    ItemData("Job Unlock: Master Monk", ItemClassification.useful, 0x313),
    ItemData("Job Unlock: Bishop", ItemClassification.useful, 0x314),
    ItemData("Job Unlock: Templar", ItemClassification.useful, 0x315),
    ItemData("Job Unlock: Cannoneer", ItemClassification.useful, 0x316),
    ItemData("Job Unlock: Trickster", ItemClassification.useful, 0x317),
    ItemData("Job Unlock: Beastmaster", ItemClassification.useful, 0x318),
    ItemData("Job Unlock: Time Mage", ItemClassification.useful, 0x319),
    ItemData("Job Unlock: Alchemist", ItemClassification.useful, 0x31a),
    ItemData("Job Unlock: Arcanist", ItemClassification.useful, 0x31b),
    ItemData("Job Unlock: Sage", ItemClassification.useful, 0x31c),
    ItemData("Job Unlock: Scholar", ItemClassification.useful, 0x31d),
    #ItemData("Job Unlock: Keeper", ItemClassification.useful, 0x31e),
    ItemData("Job Unlock: Fencer", ItemClassification.useful, 0x31f),
    ItemData("Job Unlock: Green Mage", ItemClassification.useful, 0x320),
    ItemData("Job Unlock: Elementalist", ItemClassification.useful, 0x321),
    ItemData("Job Unlock: Red Mage", ItemClassification.useful, 0x322),
    ItemData("Job Unlock: Spellblade", ItemClassification.useful, 0x323),
    ItemData("Job Unlock: Summoner", ItemClassification.useful, 0x324),
    ItemData("Job Unlock: Assassin", ItemClassification.useful, 0x325),
    ItemData("Job Unlock: Sniper", ItemClassification.useful, 0x326),
    ItemData("Job Unlock: Animist", ItemClassification.useful, 0x327),
    ItemData("Job Unlock: Moogle Knight", ItemClassification.useful, 0x328),
    ItemData("Job Unlock: Fusilier", ItemClassification.useful, 0x329),
    ItemData("Job Unlock: Juggler", ItemClassification.useful, 0x32a),
    ItemData("Job Unlock: Tinker", ItemClassification.useful, 0x32b),
    ItemData("Job Unlock: Chocobo Knight", ItemClassification.useful, 0x32c),
    ItemData("Job Unlock: Flintlock", ItemClassification.useful, 0x32d),
    ItemData("Job Unlock: Berserker", ItemClassification.useful, 0x32e),
    ItemData("Job Unlock: Ranger", ItemClassification.useful, 0x32f),
    ItemData("Job Unlock: Lanista", ItemClassification.useful, 0x330),
    ItemData("Job Unlock: Viking", ItemClassification.useful, 0x331),
    ItemData("Job Unlock: Raptor", ItemClassification.useful, 0x332),
    ItemData("Job Unlock: Ravager", ItemClassification.useful, 0x333),
    ItemData("Job Unlock: Geomancer", ItemClassification.useful, 0x334),
]
