...
AllItems: typing.List[ItemData] = Weapons + EquipShields + EquipHelmets + EquipHats + EquipArmor + \
                                  EquipClothing + EquipRobes + EquipShoes + EquipGloves + EquipRings + \
                                  Consumables + Loot + GateItems + jobUnlockItems
